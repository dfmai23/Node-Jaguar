...
#define WaveDAC8_1_WAVE1_LENGTH   (50u)   /* Length for wave1 */
...
#define WaveDAC8_1_SetSpeed(speed)      WaveDAC8_1_VDAC8_SetSpeed(speed)
#define WaveDAC8_1_SetRange(range)      WaveDAC8_1_VDAC8_SetRange(range)
#define WaveDAC8_1_SetValue(value)      WaveDAC8_1_VDAC8_SetValue(value)
#define WaveDAC8_1_DacTrim(void)        WaveDAC8_1_VDAC8_DacTrim()
#define WaveDAC8_1_SaveConfig(void)     WaveDAC8_1_VDAC8_SaveConfig()
#define WaveDAC8_1_RestoreConfig(void)  WaveDAC8_1_VDAC8_RestoreConfig()
