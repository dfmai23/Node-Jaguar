...
#define c1_critical_timer_Resolution                 16u
...
***************************************/
    ...
    ***************************************/
    ...
    #define c1_critical_timer_CONTROL             (* (reg8 *) c1_critical_timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define c1_critical_timer_CAPTURE_LSB         (* (reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define c1_critical_timer_CAPTURE_LSB_PTR       ((reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define c1_critical_timer_PERIOD_LSB          (* (reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define c1_critical_timer_PERIOD_LSB_PTR        ((reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define c1_critical_timer_COUNTER_LSB         (* (reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define c1_critical_timer_COUNTER_LSB_PTR       ((reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(c1_critical_timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define c1_critical_timer_CAPTURE_LSB         (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define c1_critical_timer_CAPTURE_LSB_PTR       ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
            #define c1_critical_timer_PERIOD_LSB          (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define c1_critical_timer_PERIOD_LSB_PTR        ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
            #define c1_critical_timer_COUNTER_LSB         (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
            #define c1_critical_timer_COUNTER_LSB_PTR       ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define c1_critical_timer_CAPTURE_LSB         (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define c1_critical_timer_CAPTURE_LSB_PTR       ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define c1_critical_timer_PERIOD_LSB          (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define c1_critical_timer_PERIOD_LSB_PTR        ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define c1_critical_timer_COUNTER_LSB         (* (reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define c1_critical_timer_COUNTER_LSB_PTR       ((reg16 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(c1_critical_timer_Resolution <= 24u)/* 24-bit Timer */
        #define c1_critical_timer_CAPTURE_LSB         (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define c1_critical_timer_CAPTURE_LSB_PTR       ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define c1_critical_timer_PERIOD_LSB          (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define c1_critical_timer_PERIOD_LSB_PTR        ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define c1_critical_timer_COUNTER_LSB         (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define c1_critical_timer_COUNTER_LSB_PTR       ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define c1_critical_timer_CAPTURE_LSB         (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define c1_critical_timer_CAPTURE_LSB_PTR       ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define c1_critical_timer_PERIOD_LSB          (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define c1_critical_timer_PERIOD_LSB_PTR        ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define c1_critical_timer_COUNTER_LSB         (* (reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define c1_critical_timer_COUNTER_LSB_PTR       ((reg32 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define c1_critical_timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) c1_critical_timer_TimerUDB_sT16_timerdp_u0__A0_REG )
