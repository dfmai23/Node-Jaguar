...
{
   #if(b3_critical_timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(b3_critical_timer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(b3_critical_timer_PERIOD_LSB_PTR));
   #endif /* (b3_critical_timer_UsingFixedFunction) */
}
...
void b3_critical_timer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(b3_critical_timer_PERIOD_LSB_PTR, period);
...
{
   #if(b3_critical_timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(b3_critical_timer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(b3_critical_timer_CAPTURE_LSB_PTR));
   #endif /* (b3_critical_timer_UsingFixedFunction) */
}
...
void b3_critical_timer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(b3_critical_timer_COUNTER_LSB_PTR, counter);
